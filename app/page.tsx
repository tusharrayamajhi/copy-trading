...
export default function Home() {
  ...
  return (
    <main className="relative min-h-screen bg-[#020617] text-slate-200 overflow-x-hidden selection:bg-cyan-500/30">
      ...
      {/* Footer */}
      <footer className="relative z-10 border-t border-slate-900 py-20">
        <div className="container mx-auto px-6 text-center">
            <div className="flex items-center justify-center gap-3 mb-8">
                <div className="w-8 h-8 bg-slate-800 rounded-lg flex items-center justify-center">
                    <TrendingUp className="text-cyan-400 w-5 h-5" />
                </div>
                <span className="text-lg font-black italic">ANTIGRAVITY</span>
            </div>
            <p className="text-slate-600 text-sm max-w-md mx-auto leading-relaxed">
                © 2026 Antigravity Protocol. The first decentralized copy-trading platform built for speed and security on Solana.
            </p>
        </div>
      </footer>
    </main>
