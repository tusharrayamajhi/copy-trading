...
import { Activity, Copy, CheckCircle2, AlertCircle } from "lucide-react";
    ...
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 mt-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <div className="bg-slate-800/50 p-6 rounded-2xl border border-slate-700">
          ...
          <p className="text-3xl font-bold">${(traderData.totalSharesValueUsd?.toNumber() / 10**6).toFixed(2) || "0.00"}</p>
        </div>
        <div className="bg-slate-800/50 p-6 rounded-2xl border border-slate-700">
          <p className="text-slate-400 text-sm mb-1">Lifetime Profit Generated</p>
          <p className="text-3xl font-bold text-green-400">+${(traderData.lifetimeProfitUsd?.toNumber() / 10**6).toFixed(2) || "0.00"}</p>
        </div>
        <div className="bg-slate-800/50 p-6 rounded-2xl border border-slate-700">
